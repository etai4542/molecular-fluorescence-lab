...
FL.conc    = [1, 0.5, 0.25, 0.1, 0.05, 0.025, 0.01, 0.008, 0.001];
...
for m = 1:n_mat
    ...
    cf = coeffvalues(lf);
    fprintf('\n--- %s ---\n', mat.name);
    fprintf('  Linear fit  |  epsilon = %.4f cm^-1 mM^-1  |  R^2 = %.6f  |  RMSE = %.4e\n', ...
            cf(1), lg.rsquare, lg.rmse);
